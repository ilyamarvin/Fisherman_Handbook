...
public class ContentActivity extends AppCompatActivity {
    ...
    private int[] array_starter = {
            R.string.starter_1, R.string.starter_2, R.string.starter_3, R.string.starter_4, R.string.starter_5,
    ...
    private int[] array_image_fish = {
            R.drawable.ukleyka, R.drawable.plotva, R.drawable.elec, R.drawable.krasnoperka, R.drawable.karas, R.drawable.karp,
            R.drawable.schuka, R.drawable.lesh, R.drawable.som, R.drawable.rotan, R.drawable.okun, R.drawable.golavl, R.drawable.zhereh, R.drawable.yaz,
            R.drawable.gustera, R.drawable.amur
    };
    private int[] array_title_fish = {
            R.string.fish_name_1, R.string.fish_name_2, R.string.fish_name_3, R.string.fish_name_4, R.string.fish_name_5,
    ...
    private int[] array_image_hook = {
            R.drawable.hooksizestandart, R.drawable.hooksizekarp, R.drawable.hooksizeofset, R.drawable.hooksizetroynik,
            R.drawable.hooksizejig, R.drawable.hooksizeogruz, R.drawable.hookjivec
    };
    private int[] array_title_hook = {
            R.string.hook_name_1, R.string.hook_name_2, R.string.hook_name_3, R.string.hook_name_4,
            R.string.hook_name_5, R.string.hook_name_6, R.string.hook_name_7
    };
    ...
    private void receiveIntent() {
        ...
        switch (category){
            ...
            case 1:
                ...
                break;
            case 2:
                imContent.setImageResource(array_image_hook[position]);
                text_content.setText(array_hooks[position]);
                actionBar.setTitle(array_title_hook[position]);
                break;
            case 3:
